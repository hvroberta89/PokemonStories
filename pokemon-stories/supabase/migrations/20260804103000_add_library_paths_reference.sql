...
alter table public.poke5e_reference_records
  ...
  check (dataset in ('pokemon', 'moves', 'abilities', 'items', 'technical-machines', 'origins', 'paths', 'contest', 'contest-effects', 'types', 'specializations', 'natures', 'feats', 'rules'));

alter table public.poke5e_reference_translations
  add constraint poke5e_reference_translations_dataset_check
  check (dataset in ('pokemon', 'moves', 'abilities', 'items', 'tms', 'technical-machines', 'origins', 'paths', 'contest-effects', 'types', 'specializations', 'natures', 'feats', 'rules'));