...
const titles: Record<LibraryView, string> = { pokemon: 'Pokémon', moves: 'Move-ok', abilities: 'Képességek', items: 'Tárgyak', tms: 'Technical Machines', origins: 'Trainer Originek', types: 'Típusok', specializations: 'Specializationök', rules: 'Szabályok', favorites: 'Kedvencek', recent: 'Legutóbb megnyitott' };
