...
alter table public.poke5e_reference_records
  ...
  check (dataset in ('pokemon', 'moves', 'abilities', 'items', 'technical-machines', 'origins', 'contest', 'contest-effects', 'types', 'rules'));

alter table public.poke5e_reference_translations
  add constraint poke5e_reference_translations_dataset_check
  check (dataset in ('pokemon', 'moves', 'abilities', 'items', 'tms', 'technical-machines', 'origins', 'contest-effects', 'types', 'rules'));